...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        public Color fogColorVal = new Color(0.45f, 0.96f, 1f, 1.0f);
        ...
        private void GetInput(out float speed)
        {
            ...
            float TempWalkingSpeed = Mathf.Clamp(m_WalkSpeed - (WalkingSpeedChange * TempWaterLevelToPlayer), 1f, 5f);
            float TempRunningSpeed = Mathf.Clamp(m_RunSpeed - (RunningSpeedChange * TempWaterLevelToPlayer), 1f, 10f);
